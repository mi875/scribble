...
extension ScribbleNotifierStorageExtension on ScribbleNotifier {
  ...
  void removeStrokesWhere(
    ...
    final filteredLines = currentSketch.lines.where((line) => !predicate(line)).toList();
  ...
  int get totalPoints => currentSketch.lines.fold(0, (sum, line) => sum + line.points.length);
}
